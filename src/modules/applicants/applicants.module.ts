...
import { PublicSkillsController } from './presentation/public-skills.controller';
import { AdminSkillsController } from './presentation/admin-skills.controller';
...
@Module({
  ...
  controllers: [
    PublicApplicantsController,
    AdminApplicantsController,
    ApplicantProfileController,
    AgentApplicantsController,
  ...
  exports: [ApplicantsService, ApplicantVerifiedService, ApplicantProfileRepository, SkillsService]
})
